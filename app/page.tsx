...
const sessions = [
  ...
  },
  {
    ...
    sleep: "良好",
    warmup: "筋膜松解 · 核心激活 · 动态伸展",
    extraSession: "拉伸课 · 30分钟",
    stretchSession: "拉伸课 · 30分钟",
    calories: null,
    actions: [
      { name: "弓步上台阶转体", sets: "3组 15次×5kg · 间歇60秒" },
      { name: "泽奇深蹲", sets: "4组 12次×50kg · 间歇90秒" },
      { name: "杠铃罗马硬拉", sets: "4组 12次×50kg · 间歇90秒" },
      { name: "哑铃弓步行走", sets: "4组 10次×15kg×2 · 间歇120秒" },
      { name: "杠铃臀推", sets: "4组 15次×70kg · 间歇90秒" },
      { name: "器械髋内收", sets: "4组 15次×30kg · 间歇90秒" },
      { name: "坐姿勾脚背", sets: "4组 15次×10kg · 间歇60秒" },
    ],
    cardio: null,
    strengthCalories: null,
    cardioCalories: null,
